  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 lg:py-12">
      <div className="container mx-auto px-4">
        ...
        {/* Failure Banner */}
        {showFailureBanner && (
          <div className="max-w-4xl mx-auto mb-8 bg-red-50 border-2 border-red-200 rounded-2xl p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    ...
                    className="bg-white text-red-900 px-6 py-3 rounded-xl font-bold border-2 border-red-300 hover:bg-red-50 transition-colors"
                  >
                    Contact Support
                  </a>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* Order Status */}
          <div
            className={`${currentStatus.bgColor} border-2 ${currentStatus.borderColor} rounded-2xl p-6 mb-6 shadow-sm`}
          >
            <div className="flex items-center gap-4">
              <div
                className={`w-16 h-16 ${currentStatus.bgColor} rounded-full flex items-center justify-center border-2 ${currentStatus.borderColor}`}
              >
              ...
              {canCancel && (
                <button
                  ...
                  className="px-6 py-3 bg-white border-2 border-red-300 text-red-900 rounded-xl font-bold hover:bg-red-50 transition-colors"
                >
                  Cancel Order
                </button>
              )}
            ...
            <div className="space-y-4 mb-6 pb-6 border-b-2 border-gray-200">
              ...
              {order.transaction_fee > 0 && (
                <div className="flex justify-between text-lg">
                  ...
                  <span className="font-bold text-gray-900">
                    ₦{order.transaction_fee.toLocaleString()}
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/"
              className="flex-1 flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-900 px-6 py-4 rounded-xl text-lg font-bold hover:border-green-900 hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl text-base focus:outline-none focus:border-green-900 resize-none mb-6"
              rows="4"
