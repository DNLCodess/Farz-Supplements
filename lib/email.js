...
const SUPPORT_EMAIL =
  process.env.RESEND_SUPPORT_EMAIL || "support@farzsupplements.com";
 ...
 * @param {object} order - Order details
 * @param {object} transaction - Payment transaction details
 * @returns {Promise<object>} Email send result
 */
            ...
            <td style="padding: 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; font-size: 16px; font-weight: 600; color: #111827; text-align: right;">
                    ${order.shipping_cost === 0 ? '<span style="color: #14532D;">Free</span>' : formatPrice(order.shipping_cost)}
                  </td>
                </tr>
                ${
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #FFFFFF; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #14532D 0%, #166534 100%); padding: 40px; text-align: center;">
              <div style="width: 80px; height: 80px; background-color: #FFFFFF; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #FFFFFF; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="padding: 40px; text-align: center;">
              <div style="width: 80px; height: 80px; background-color: #FEF2F2; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center;">
            ...
            <td style="padding: 0 40px 40px 40px;">
              ...
              ${
                order.payment_status === "paid"
                  ? `
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 24px; color: #6B7280;">
                Your payment of <strong>${formatPrice(order.total_amount)}</strong> will be refunded within 5-7 business days.
              </p>
              `
                  : ""
              }
